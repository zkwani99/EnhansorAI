        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`text-4xl lg:text-5xl text-white mb-6 ${
              ...
              Gallery & <span className="bg-gradient-to-b from-fuchsia-500 to-purple-700 bg-clip-text text-transparent">Examples</span>
            </h2>
            ...
            {categories.map((category) => (
              <div key={category.id} className={`${
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Button 
                    variant="ghost" 
                    className="text-fuchsia-400 hover:text-purple-300 hover:bg-fuchsia-500/10"
            ...
            <>
              ...
              <div className="px-6 pb-6">
                ...
                <div className="flex items-center justify-between text-sm text-gray-300">
                  ...
                  <Button
                    className="bg-gradient-to-b from-fuchsia-500 to-purple-700 hover:from-fuchsia-600 hover:to-purple-800"
