            ...
            return (
              ...
              >
                ...
                <div className="relative mb-6 flex justify-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-primary-purple to-purple-400 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <IconComponent className="text-white" size={32} />
                  </div>
                  {/* Subtle glow effect */}
                  <div className="absolute inset-0 w-16 h-16 bg-gradient-to-br from-primary-purple to-purple-400 rounded-2xl opacity-20 blur-lg group-hover:opacity-30 transition-opacity duration-300"></div>
                </div>

                {/* Content */}
                <div className="space-y-3">
                  <h3 className="text-xl font-bold text-gray-900 group-hover:text-primary-purple transition-colors duration-300">
                    {feature.title}
                  </h3>
