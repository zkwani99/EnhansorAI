...
export default function ServicesSection() {
  ...
  const getColorClasses = (color: string) => {
    switch (color) {
      case "blue":
        return {
          border: "border-fuchsia-100 hover:border-fuchsia-500",
          icon: "bg-gradient-to-b from-fuchsia-500 to-purple-700",
          checkIcon: "text-fuchsia-500",
          button: "bg-gradient-to-b from-fuchsia-500 to-purple-700"
        };
      case "purple":
        return {
          border: "border-fuchsia-100 hover:border-fuchsia-500",
          ...
          {services.map((service) => {
            ...
            return (
              <Card
                key={service.id}
                id={service.id}
                className={`group bg-white dark:bg-black rounded-2xl shadow-lg hover:shadow-2xl hover:border-fuchsia-500 hover:shadow-purple-500/20 transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.02] border ${colorClasses.border} h-full`}
