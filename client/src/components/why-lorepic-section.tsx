...
export default function WhyLorepicSection() {
  ...
  return (
    ...
    >
      ...
      {/* Bottom curved divider - dark background extending to DiscoverServicesSection below */}
      <CurvedDivider 
        position="bottom" 
        fillColor="#0f172a" 
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto ${
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`group bg-gray-800 border border-gray-700 hover:border-purple-500 rounded-xl p-6 shadow-sm hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300 transform hover:-translate-y-1 ${
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center justify-center space-x-8 bg-gray-800 rounded-xl px-8 py-6 border border-gray-700 shadow-sm">
            <div className="flex -space-x-3">
              <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=120&h=120&fit=crop&crop=face&auto=format" alt="Creator" className="w-10 h-10 rounded-full border-2 border-gray-800 shadow-sm object-cover" />
            ...
            <div className="text-left">
              ...
              <div className="text-sm text-gray-300">Growing every day</div>
            </div>
