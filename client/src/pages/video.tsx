      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-6">
            Text-to-Video <span className="text-[hsl(258,90%,66%)]">Creator</span>
          </h1>
          <p className="text-xl text-slate-600 dark:text-slate-400 mb-8">
            Generate dynamic videos from your text descriptions with AI technology
          </p>
          
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white mb-4">
              Welcome to Text-to-Video Creation!
            </h2>
            <p className="text-slate-600 dark:text-slate-400 mb-6">
              Bring your stories to life by converting text prompts into engaging, 
              high-quality video content powered by cutting-edge AI.
            </p>
